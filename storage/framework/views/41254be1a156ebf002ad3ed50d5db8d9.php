...
<body>
    ...
    <?php
        ...
        <?php if($hasil_olga == "anda kurang berolahraga" && $hasil_tidur == "Kondisi tubuh anda KURANG TIDUR"): ?>
            Tubuh anda kurang sehat
        <?php elseif($hasil_olga == "anda kurang berolahraga" && $hasil_tidur == "Kondisi tubuh anda TIDUR CUKUP"): ?>
            Tidur Cukup, Tapi Olahraga Kurang
        <?php elseif($hasil_olga == "anda kurang berolahraga" && $hasil_tidur == "Kondisi tubuh anda TIDUR BERLEBIHAN"): ?>
            Pola Tidur dan pola olahraga tidak sehat!
        <?php elseif($hasil_olga == "anda berolahraga" && $hasil_tidur == "Kondisi tubuh anda KURANG TIDUR"): ?>
            Tubuh anda kurang beristirahat
        <?php elseif($hasil_olga == "anda berolahraga" && $hasil_tidur == "Kondisi tubuh anda TIDUR CUKUP"): ?>
            Tubuh anda sehat
        <?php elseif($hasil_olga == "anda berolahraga" && $hasil_tidur == "Kondisi tubuh anda TIDUR BERLEBIHAN"): ?>
...
</html><?php /**PATH E:\Kuliah\semester 2\STATITIKA DAN PROBABILITAS\Tubes\MasterLaravel10\resources\views/fitur.blade.php ENDPATH**/ ?>